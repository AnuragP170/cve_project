...
check_windows_antivirus():
 ...
 - How it works: Uses netsh to check for windows firewall.
...
check_agent_based_log_collection_windows():
 ...
 - How it works: Iterates through a list of known log collection agent services and checks if they are running using psutil.win_service_iter(). If a service is found, it's added to the detected programs list. Only tested on Wazuh so far
